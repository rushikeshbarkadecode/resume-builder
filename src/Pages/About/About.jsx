...
const testimonials = [
    {
        ...
        avatar:
            'https://avatars.githubusercontent.com/u/143509436?v=4',
    }
];
    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:image" content="https://avatars.githubusercontent.com/u/143509436?v=4" />
            ...
            <Flex
                ...
                <Box width={{ base: 'full', sm: 'lg', lg: 'xl' }} margin={'auto'}>
                    ...
                    <chakra.h2
                        ...
                        Build resume that will get you hired
                    </chakra.h2>
                </Box>
                <SimpleGrid
                    columns={{ base: 1, xl: 1 }}
